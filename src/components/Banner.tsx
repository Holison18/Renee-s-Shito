...
const bannerImages = [
  ...
  { src: banner2, alt: "Traditional African Cooking" },
  { src: banner3, alt: "Premium Shito Products" }
];
...
const Banner = () => {
  ...
  return (
    <div className="relative w-full h-64 md:h-80 lg:h-96 overflow-hidden rounded-lg border border-accent shadow-lg">
      <div 
